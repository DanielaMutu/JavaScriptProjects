...
function placeXOrO(squareNumber) {
    //check if the square has been selcted already
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)  {
    ...
    function animateLineDrawing() {
        const animationLoop = requestAnimatioFrame(animateLineDrawing);
    ...
    animateLineDrawing();
    setTimout(function () { clear(); resetGame(); }, 1000);
}
